  ...
  return (
    <article className="prose prose-sm max-w-none">
      ...
      <section className="mb-8">
        <h2 className="text-base font-semibold text-gray-900 mb-2">Éditeur du service</h2>
      ...
      <section className="mb-8">
        <h2 className="text-base font-semibold text-gray-900 mb-2">Activité réglementée</h2>
        <p className="text-sm text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-base font-semibold text-gray-900 mb-2">Responsabilité</h2>
        <p className="text-sm text-gray-700 leading-relaxed">
